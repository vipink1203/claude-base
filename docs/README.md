...
This directory holds planning and design artifacts generated by the BMAD planning workflow.
...
├── README.md              # This file
├── help/
│   ├── claude.md          # Claude /project-help reference
│   ├── gemini.md          # Gemini /project-help reference
│   └── codex.md           # Codex $project-help reference
├── briefs/
...
- Claude: `/project-help` (from `.claude/commands/project-help.md`)
- Gemini: `/project-help` (from `.gemini/commands/project-help.toml`)
- Codex: `$project-help` (from `.agents/skills/project-help/SKILL.md`)
